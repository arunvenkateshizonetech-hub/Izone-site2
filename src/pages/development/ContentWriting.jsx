        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-slate-900 dark:text-primary-foreground leading-tight">
              Words That
              <span className="bg-gradient-to-r from-[hsl(var(--primary))] to-[hsl(var(--accent))] bg-clip-text text-transparent block mt-2">Convert Fast</span>
            </h1>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-5xl font-black text-primary-foreground mb-6 leading-tight"> Ready to Deploy Your Narrative Vision?</h2>
