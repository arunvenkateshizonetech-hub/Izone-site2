        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-5xl font-black text-primary-foreground mb-6 leading-tight">Ready to Elevate Your Visual Brand?</h2>
              ...
              <Link to="/" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                <TypedButton size="lg" className="bg-white text-[hsl(var(--primary))] hover:bg-slate-100 font-black py-8 px-12 text-xl rounded-2xl shadow-2xl transition-all hover:-translate-y-2 active:scale-95">
